                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    <p class="profile-title">Dr. <?php echo explode(' ', trim($username))[0]; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Sessions Manager</p>
                ...
                <?php
                    $sqlmain= "select * from tbl_schedule where docid='$userid' order by scheduledate desc";
                    ...
                    if($_POST){
                        ...
                        if(!empty($_POST["sheduledate"])){
                            ...
                            $sqlmain.=" and scheduledate='$sheduledate' ";
                        };
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;white-space: nowrap;"><font class="tn-in-text">Cancel</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                        Session has been successfully deleted.<br><br>
            ...
            $sqlmain= "select * from tbl_schedule where scheduleid='$id'";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $title=$row["title"];
            $nop=$row["nop"];
            ...
            $start_time=$row["start_time"];
            $end_time=$row["end_time"];
            $sqlmain2= "select * from tbl_appointment where scheduleid='$id'";
            $result2= $database->query($sqlmain2);
            $apponum=0;
            if($result2->num_rows>0){
                $apponum=$result2->num_rows;
            }
            echo '
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Session Details.</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Number of Appointment Places: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">Number of Appointments Booked: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                            <td class="label-td" colspan="2">
                            '.($end_time ? date('h:i A', strtotime($start_time)) . ' - ' . date('h:i A', strtotime($end_time)) : date('h:i A', strtotime($start_time))).'<br><br>
                            </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <a href="schedule.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
